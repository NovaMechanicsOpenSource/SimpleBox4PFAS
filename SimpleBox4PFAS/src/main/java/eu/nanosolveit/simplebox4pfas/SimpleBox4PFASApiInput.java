...
@ApiModel(value="Simple box 4 pfas input")
public class SimpleBox4PFASApiInput {
	...
	@Getter @Setter
	@ApiModelProperty(value="EMISSION to water0")
	Double E_w0RS;
	
	@Getter @Setter
	@ApiModelProperty(value="EMISSION to water1")
	Double E_w1RS;

	@Getter @Setter
	@ApiModelProperty(value="EMISSION to water2")
	Double E_w2RS;
	...
	@Getter @Setter
	@ApiModelProperty(value="EMISSION to agricultural soil")
	Double E_s2RS;
